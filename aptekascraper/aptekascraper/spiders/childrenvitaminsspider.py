...
class ChildrenVitaminsSpider(scrapy.Spider):
    name = "childrenvitaminsspider"
    allowed_domains = ["apteka-ot-sklada.ru"]
    start_urls = ["https://apteka-ot-sklada.ru/tomsk/catalog/"
                  "medikamenty-i-bady/vitaminy-i-mikroelementy/"
                  "vitaminy-dlya-detey"]
    custom_settings = {
        'FEEDS': {
            'children_vitamins.json': {'format': 'json', 'overwrite': True},
        }
    }
