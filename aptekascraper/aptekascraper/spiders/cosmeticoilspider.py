...
class CosmeticOilSpider(scrapy.Spider):
    name = "cosmeticoilspider"
    allowed_domains = ["apteka-ot-sklada.ru"]
    start_urls = ["https://apteka-ot-sklada.ru/tomsk/catalog/kosmetika/"
                  "masla-kosmeticheskie/kosmeticheskoe-maslo/"]
    custom_settings = {
        'FEEDS': {
            'cosmetic_oils.json': {'format': 'json', 'overwrite': True},
        }
    }
